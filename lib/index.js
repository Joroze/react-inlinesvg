...
var InlineSVG = /** @class */ (function (_super) {
    ...
    function InlineSVG(props) {
        ...
        _this.request = function () {
            var _a = _this.props, cacheRequests = _a.cacheRequests, cacheFailedRequests = _a.cacheFailedRequests, src = _a.src;
            if (cacheRequests) {
                exports.storage[src] = { url: src, content: '', loading: true, queue: [] };
            }
            try {
                return fetch(src)
                    ...
                    /* istanbul ignore else */
                    if (cacheRequests && src in exports.storage) {
                        var cachedItem = exports.storage[src];
        ...
        _this.state = {
            content: '',
            element: null,
            hasCache: !!props.cacheRequests && props.src in exports.storage,
    ...
    InlineSVG.prototype.generateElement = function () {
        var _a = this.props, baseURL = _a.baseURL, cacheRequests = _a.cacheRequests, cacheFailedRequests = _a.cacheFailedRequests, children = _a.children, description = _a.description, onError = _a.onError, onLoad = _a.onLoad, loader = _a.loader, preProcessor = _a.preProcessor, src = _a.src, title = _a.title, uniqueHash = _a.uniqueHash, uniquifyIDs = _a.uniquifyIDs, rest = __rest(_a, ["baseURL", "cacheRequests", "cacheFailedRequests", "children", "description", "onError", "onLoad", "loader", "preProcessor", "src", "title", "uniqueHash", "uniquifyIDs"]);
        try {
    ...
    InlineSVG.prototype.load = function () {
        ...
        if (this.isMounted) {
            this.setState({
                ...
                var cache = cacheRequests && exports.storage[src];
                if (cache) {
                    if (cache.loading) {
